        ...
        <AdminLayout>
            ...
            ? <Modal>
                <div>
                    <div className="flex justify-between">
                        <div className="mb-6">
                            <p className="font-semibold text-xl">Create Item</p>
                        </div>
                        <div>
            ...
            ? <Modal>
                <div>
                    <div className="flex justify-between">
                        <div className="mb-6">
                            <p className="font-semibold text-xl">Edit Item</p>
                        </div>
                        <div>
            ...
            ? <Modal>
                <div className="w-100">
                    <div className="flex justify-between">
                        <div className="mb-6">
                            <p className="font-semibold text-xl">Delete Item</p>
                        </div>
                        <div>
            ...
            <div>
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <p className="font-semibold text-xl bg-[#47455b] hover:bg-[#525068] text-white rounded-md px-2 p-1 transition-all">Inventory</p>
                        <div className="w-10 flex items-center justify-center">
                            <div className="w-0.5 h-9 bg-[#47455b]"></div>
                        </div>
                        <Link to={'/admin/consumable'}>
                            <p className="font-semibold text-xl text-gray-500 bg-gray-200 hover:bg-gray-300 rounded-md px-2 p-1 transition-all">Consumable</p>
                        </Link>
                    </div>
