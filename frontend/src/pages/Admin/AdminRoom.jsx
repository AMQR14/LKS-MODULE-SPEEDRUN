                ...
                <div>
                    ...
                    <form action="" className="gap-4 flex flex-col w-100">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="number" min={1} placeholder="Enter capacity" className="border-2 p-2 border-gray-200 transition-all focus:outline-none rounded-md hover:border-[#525068]"/>
                        </div>
                        <div className="flex flex-col gap-2">
