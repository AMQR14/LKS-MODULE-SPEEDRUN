                ...
                <div>
                    ...
                    <form action="" className="gap-4 flex flex-col w-100">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="number" min={1} placeholder="Enter time" className="border-2 p-2 border-gray-200 transition-all focus:outline-none rounded-md hover:border-[#525068]"/>
                        </div>
                        <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="bg-[#47455b] text-white p-1 rounded-md px-2">$67</div>
                        </div>
